...
@section('content')
    <section class="position-relative overflow-hidden" style="z-index:1;">
        ...
        <div class="form_container bg-white shadow rounded my-5 py-3 position-relative" style="z-index: 1;">
            <form action="{{route('apply_number_submit')}}" method="post" enctype="multipart/form-data" id="ipForm">
                @csrf
                <p class="h3 fw-bold text-center mt-3">Apply For Your IP Number</p>
                @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="ip_number" id="ip_number" placeholder="096XXXXXXXX"/>
                            </div>
